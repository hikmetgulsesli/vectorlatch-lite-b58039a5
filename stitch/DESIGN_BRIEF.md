...
- VectorLatch Lite turns the user's request into a directly usable game workflow. The first experience must be the actual browser game behavior, not a marketing landing page or placeholder demo.
- - FR-001: Build a compact browser-game called VectorLatch Lite. It should be a full-viewport timing arcade game where the player releases a moving latch to catch glowing vector nodes on a rail. Include a gameplay screen, settings screen, score/level/progress indicators, pause/resume/restart controls, keyboard and clic…
...
- Gameplay - VectorLatch Lite
- Game Settings - VectorLatch Lite

## SCREEN_SPECS
SCREEN_SPEC_1:
- exact_screen_title: Gameplay - VectorLatch Lite
...
SCREEN_SPEC_2:
- exact_screen_title: Game Settings - VectorLatch Lite
